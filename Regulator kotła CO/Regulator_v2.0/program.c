...
{
            if(G_Tkotla_reguAktualna>=G_Tkotla_reguWygasz){
                switch(G_Przedmuch){
                   case 0: SetKotlaWentylatorON(); break;
                   case 1: set_pause_przedmuch(1); break;
                   case 2: set_pause_przedmuch(2); break;
                   case 3: set_pause_przedmuch(3); break;
                   case 4: set_pause_przedmuch(4); break;
                }
            }
           else 
...
void ShowLogoOnLCD(void){
  ...
  lcd_putstr_goto("__ver: 1.0__",3,5); 
