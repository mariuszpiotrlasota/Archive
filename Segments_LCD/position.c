...
void write(int position,char letter) // writes a single character on the LCD. User can specify position as well
{
 ...
 else if(position==1)
  {
    ...
    switch(letter){ case '2':  LCDMEM[seg_ijkl+1]=BIT1;break;       case '3': LCDMEM[seg_ijkl+1]=BIT1; break;
                    ...
                    case '9':  LCDMEM[seg_ijkl+1]=BIT1;break;       case '0': LCDMEM[seg_ijkl+1]=BIT1; break;
  ...
  //************************glowna petal swith
      ...
      case '0':  LCDMEM[seg_abcd]=(LCDMEM[seg_abcd]|((a+b+c+d+k)<<move_s1));   LCDMEM[seg_hgfe]=(LCDMEM[seg_hgfe]|((e+f+g+h+o)<<move_s2));   LCDMEM[seg_ijkl]=(LCDMEM[seg_ijkl]|((k)>>move_s3));break;
      ...
      case 'C':  LCDMEM[seg_abcd]=(LCDMEM[seg_abcd]|((a+k+d)<<move_s1));       LCDMEM[seg_hgfe]=(LCDMEM[seg_hgfe]|((e+f+g+h)<<move_s2));     ;break;
